<?php 
    ...
    if (isset($_POST['simpan'])) {
        ...
        mysqli_query($db, "UPDATE tbpoktan
                            SET kd_poktan='$kd_poktan', kelurahan='$kelurahan', nm_poktan='$nm_poktan', nm_ketua='$nm_ketua',
                            no_telp='$no_telp', nm_sekretaris='$nm_sekretaris', nm_bendahara='$nm_bendahara', alamat='$alamat', 
                            luas_lahan='$luas_lahan', jumlah_petani='$jumlah_petani', tahun_berdiri='$tahun_berdiri', kelas='$kelas', nm_penyuluh_wkpp='$nm_penyuluh_wkpp'
