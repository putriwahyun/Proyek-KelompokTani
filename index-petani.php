...
<body>
    <div class="sidebar">
        ...
        <ul class="nav_list">
            <li>
                <a href="index-petani.php?p=dashboard-petani">
            ...
            <li>
                <a href="index-petani.php?p=kelompok-tani-petani">
            ...
            <li>
                <a href="index-petani.php?p=anggota-petani">
            ...
            <li>
                <a href="index-petani.php?p=bantuan-petani">
            ...
            <li>
                <a href="index-petani.php?p=penyuluhan-petani">
            ...
            <li>
                <a href="index-petani.php?p=laporan-petani">
...
<?php
    ...
    header('location:login-petani.php');
}
?>